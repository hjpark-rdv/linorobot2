...
namespace gazebo
{
    ...
    private:
        // ======================= MODIFICATION 1 =======================
        // The second argument is changed to pass the calculated ray direction vector.
        void InitializeRays(std::vector<std::pair<int, ignition::math::Vector3d>> &points_pair,
        ...
        // ======================= MODIFICATION 2 =======================
        // Member variable to store pre-calculated relative ray directions.
        std::vector<ignition::math::Vector3d> precomputed_rays_;
        // ===============================================================
    };
